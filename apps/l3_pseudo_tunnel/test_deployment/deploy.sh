...
docker cp '/home/vmetodiev/Projects/packetcord.io/build/apps/l3_pseudo_tunnel/l3_pseudo_tunnel_server' container_2:/root/l3_pseudo_tunnel_server
docker exec container_2 chmod +x /root/l3_pseudo_tunnel_server

# Copy Network App for container_5
docker cp '/home/vmetodiev/Projects/packetcord.io/build/apps/l3_pseudo_tunnel/l3_pseudo_tunnel_client' container_5:/root/l3_pseudo_tunnel_client
docker exec container_5 chmod +x /root/l3_pseudo_tunnel_client
